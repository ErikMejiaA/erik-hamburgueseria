    ...
    public partial class InitialMigrationsCreateV1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Haburguesas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Haburguesas_Categorias_Categoria_id",
                        column: x => x.Categoria_id,
                        principalTable: "Categorias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Haburguesas_Chefs_Chef_id",
                        column: x => x.Chef_id,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hamburguesa_Ingredientes_Haburguesas_Hamburguesa_id",
                        column: x => x.Hamburguesa_id,
                        principalTable: "Haburguesas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Haburguesas_Categoria_id",
                table: "Haburguesas",
                column: "Categoria_id");

            migrationBuilder.CreateIndex(
                name: "IX_Haburguesas_Chef_id",
                table: "Haburguesas",
                column: "Chef_id");
